...
![Multi-Agent Workflows: Lessons from Building in Production supporting diagram 1](/images/blog/multi-agent-workflows-lessons-from-building-in-production/image-1.png)
...
![Multi-Agent Workflows: Lessons from Building in Production supporting diagram 2](/images/blog/multi-agent-workflows-lessons-from-building-in-production/image-2.png)
