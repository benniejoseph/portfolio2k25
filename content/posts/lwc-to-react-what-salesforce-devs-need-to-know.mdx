...
3. Learn TypeScript properly.
4. Learn server-state management with TanStack Query.
5. Learn routing.
6. Learn form handling and validation.
7. Learn authentication patterns.
8. Learn how a backend-for-frontend protects Salesforce.
9. Learn deployment and observability.
